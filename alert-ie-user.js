...
'#ieAlertBox { width: 656px; height: 480px; margin: auto; margin-top: 100px; background: #fff; border: 1px solid #777; border-radius: 3px; box-shadow: 3px 3px 20px 10px #222; }'+
